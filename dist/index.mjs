...
function slugify(text) {
  ...
  return text.toString().toLowerCase().replace("&", "-38-").replace(/\s+/g, "-").replace(textToCompare, (c) => to.charAt(from.indexOf(c))).replace(/[&.]/g, "-").replace(/[^\w-+]+/g, "").replace(/--+/g, "-").replace(/^-+/, "").replace(/-+$/, "");
}
export {
  slugify
};
